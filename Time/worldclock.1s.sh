...
ZONES="US/Pacific US/Central US/Eastern UTC Europe/London Europe/Berlin Europe/Minsk Asia/Kolkata Australia/Sydney Australia/Adelaide"
date +'%H:%M'
echo '---'
for zone in $ZONES; do
  echo "$(TZ=$zone date +'%d/%b %H:%M:%S %z') $zone"
done
